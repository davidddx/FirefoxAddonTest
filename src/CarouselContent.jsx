...
function PresenceLogo({ presence }) {
	...
	const getSvgByPresence = (P) => {
		const svg_class_name = "better-carousel-avatar-status-svg";
					...
					>
						...
						>
							<circle
								...
								r="5"
							/>
							<path d="M18 20s5 0 6 1 2 6 2 6-3.1 2-8 2-8-2-8-2 1-5 2-6 6-1 6-1" />
						</g>
					</svg>
				);
				...
				return (
					...
					>
						<path
							...
							strokeLinejoin="round"
							strokeWidth="2"
							d="M16 23h4l5 2h4V14l-4.8-3H12l-5 3v11h4zM11 18h4M13 16v4"
						/>
						<circle
							cx="22"
							cy="16.5"
				...
				return (
					...
					>
						<path
							...
							strokeLinejoin="round"
							strokeWidth="2"
							d="M8 11v5l2 2h5l3 3v5l2 2h5l-3-3v-3h3l3 3v-5l-2-2h-5l-3-3v-5l-2-2h-5l3 3v3h-3z"
						/>
					</svg>
				);
