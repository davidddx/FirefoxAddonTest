...
import {FriendDataContext, NumRowsContext} from './AppContext.jsx'
function App() {
	...
	return (
		<div className={app_wrapper_class_name}>
			...
			<FriendDataContext value={friend_data_context_value}>
				<CarouselHeader num_friends={user_friends.length} on_header_press={on_header_click} loading_finished={loading_finished}/>
				<CarouselContent friends={user_friends} presences={friends_presences}/>
			</FriendDataContext>
			</NumRowsContext>
		</div>	
	);
